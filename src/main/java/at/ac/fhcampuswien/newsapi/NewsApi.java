...
public class NewsApi {
    ...
    protected String requestData() throws NewsApiException { //ERROR HANDLING
        String url = buildURL();
    ...
    protected String buildURL() throws NewsApiException {
        ...
        if (endpoint == null || endpoint.getValue().length() == 0) {
            throw new NewsApiException("Endpoint ist null"); //improved ERROR HANDLING
        }

        String urlbase = String.format(NEWS_API_URL, endpoint.getValue(), getQ(), getApiKey());
    ...
    public NewsResponse getNews() throws NewsApiException { //IMPROVED ERROR HANDLING
